  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      <div className="khozo-mesh relative hidden flex-col justify-between p-12 text-white lg:flex">
        ...
        <p className="text-sm text-white/70"><a href="https://aiproductsfactory.com" target="_blank" rel="noopener noreferrer" title="Visit AI Products factory website" className="font-semibold text-lime-200 underline hover:text-white transition-colors">AI Products factory</a> · AI for Social Good</p>
      </div>
